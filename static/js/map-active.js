  ...
  var map = new GMaps({
    ...
    styles: [
      ...
      },
      {
        ...
        elementType: "geometry.fill",
        stylers: [{ visibility: "on" }, { color: "#e9eaf1" }],
      },
      {
        featureType: "poi",
        elementType: "geometry.fill",
    ...
    styles: [
      {
        featureType: "all",
        elementType: "labels.text.fill",
        stylers: [{ saturation: 36 }, { color: "#465166" }, { lightness: 40 }],
      },
      {
        featureType: "all",
      ...
      },
      {
        featureType: "administrative",
        elementType: "geometry.fill",
        stylers: [{ color: "#3a4459" }, { lightness: 5 }],
      },
      {
        featureType: "administrative",
        elementType: "geometry.stroke",
        stylers: [{ color: "#3a4459" }, { lightness: 5 }, { weight: 1.2 }],
      },
      {
        featureType: "landscape",
        elementType: "geometry",
        stylers: [{ color: "#3a4459" }, { lightness: 19 }],
      },
      {
        featureType: "poi",
        elementType: "geometry",
        stylers: [{ color: "#3a4459" }, { lightness: 15 }],
      },
      {
        featureType: "road.highway",
        elementType: "geometry.fill",
        stylers: [{ color: "#394358" }, { lightness: 10 }],
      },
      {
        featureType: "road.highway",
        elementType: "geometry.stroke",
        stylers: [{ color: "#394358" }, { lightness: 29 }, { weight: 0.2 }],
      },
      {
        featureType: "road.arterial",
        elementType: "geometry",
        stylers: [{ color: "#394358" }, { lightness: 18 }],
      },
      {
        featureType: "road.local",
        elementType: "geometry",
        stylers: [{ color: "#3a4459" }, { lightness: 16 }],
      },
      {
        featureType: "transit",
        elementType: "geometry",
